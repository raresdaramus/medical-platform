...
public record FullConsultationResponse(UUID id, UUID doctorId, UUID patientId, String status, String consultationType, LocalDateTime scheduledAt, LocalDateTime startedAt, LocalDateTime completedAt, PatientIntakeFormDto intake, List<DiagnosisResponse> diagnoses, List<PrescriptionResponse> prescriptions, List<ReferralResponse> referrals) {}
