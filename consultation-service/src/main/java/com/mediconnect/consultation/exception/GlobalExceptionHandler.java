...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> general(Exception ex) { return error("INTERNAL_ERROR", "An unexpected error occurred", HttpStatus.INTERNAL_SERVER_ERROR.value()); }
}
